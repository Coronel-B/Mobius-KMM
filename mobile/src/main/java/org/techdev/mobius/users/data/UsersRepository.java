...
import org.techdev.mobius.users.data.cloud.ICloudUsersDataSource;
...
//    Relación de composición: fuente de dato especificada en el diagrama de clases
    ...
    public static UsersRepository getInstance(
            @NotNull ICloudUsersDataSource userService,
            @NotNull Context controllerContext) {
        if (INSTANCE == null) {
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public void saveUser(@NotNull User user, final OnSaveUserListener callback) {
